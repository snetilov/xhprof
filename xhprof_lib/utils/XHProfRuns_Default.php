...
//
// This file provides a default implementation of the interface (class XHProfRunsInterface).
//

require_once "XHProfRunsInterface.php";


/**
 * XHProfRuns_Default is the default implementation of the
 * XHProfRunsInterface for saving/fetching XHProf runs.
 *
 ...
 * @author Kannan
 */
class XHProfRuns_Default implements XHProfRunsInterface {
